...
namespace Sparta_TRPG_SoloProject.Inventory
{
    public class Item
    {
        ...
        public static Dictionary<int, Item> itemData = new Dictionary<int, Item>()
        {
            ...
            {2, new Item(2,"길에서 주운 나무막대",ItemType.Weapon,new List<Stat>{(new Stat(ItemStatType.damage,1))},"버려진 옷을 주워다 진열해 놓은거 같다.",300) },
            ...
            {6, new Item(6,"나무 몽둥이",ItemType.Weapon,new List<Stat>{(new Stat(ItemStatType.damage,3))}, "누군가 조잡하게 나무를 깎은 모양새다.",700) },
